...
from api_caixaReg import verifi_id, sub_total, limpa_tabrotativa, del_procompra
...
principal.bt_pesquisar.clicked.connect(verifi_id) #Botão encarregado de pesquisar o valor unitario e o nome do produto.
